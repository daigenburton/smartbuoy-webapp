      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('sb_theme'),f=localStorage.getItem('sb_font'),c=localStorage.getItem('sb_colorblind'),h=document.documentElement;if(t==='dark')h.classList.add('dark');else if(t==='light')h.classList.add('light');if(f&&f!=='default')h.classList.add('font-'+f);if(c==='true')h.classList.add('colorblind');}catch(e){}})();`,
          }}
        />
      </head>
