...
public class GeofenceServiceTest {
  ...
  public void testInsideFence() {
    Deployment d = new Deployment(1, "testuser", 42.0, -70.0, 1000, System.currentTimeMillis());
  ...
  public void testOutsideFence() {
    Deployment d = new Deployment(1, "testuser", 42.0, -70.0, 50, System.currentTimeMillis());
